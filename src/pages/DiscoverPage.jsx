...
const regions = ['Maharashtra', 'Goa', 'Rajasthan', 'Delhi', 'United States', 'United Kingdom', 'Russia', 'Dubai', 'Japan']
function DiscoverPage() {
  ...
  const filteredStays = useMemo(() => {
    ...
    return stays.filter((stay) => {
      const matchesQuery = !normalizedQuery || `${stay.title} ${stay.location}`.toLowerCase().includes(normalizedQuery)
      const matchesRegion = (region === 'Maharashtra' && /Maharashtra/i.test(stay.location))
        ...
        || (region === 'United Kingdom' && /United Kingdom/i.test(stay.location))
      ...
      <main className="discover-page">
        <section className="page-intro">
          ...
          <div className="intro-image">
            <img src="https://images.unsplash.com/photo-1499793983690-e29da59ef1c2?auto=format&fit=crop&w=1100&q=85" alt="Sunlit beach house overlooking the sea" />
          </div>
        </section>
